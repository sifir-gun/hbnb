...
if __name__ == '__main__':
    """
    Ce bloc vérifie si le script est exécuté directement (et non importé en tant que module).
    Si c'est le cas, il lance l'application Flask avec l'option 'debug' activée.
    
    L'option 'debug=True' permet de relancer l'application automatiquement lors des changements 
    de code et fournit des informations de débogage en cas d'erreurs.
    """
    app.run(debug=True)
