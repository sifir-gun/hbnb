...
# This allows importing the 'app' module even if this file is executed from another directory.
...
if __name__ == '__main__':
    """
    This block checks if the script is executed directly (not imported as a module).
    If so, it starts the Flask application with the 'debug' option enabled.

    The 'debug=True' option allows the application to restart automatically on code changes
    and provides debugging information in case of errors.
    """
    app.run(debug=True)
