...
class Repository(ABC):
    ...
    de certaines méthodes via des abstractions pour gérer les objets dans un
    dépôt.
    """
    ...
    def get(self, obj_id):
        ...
        Returns:
            L'objet correspondant à l'identifiant donné, ou None si l'objet
            n'existe pas.
        """
        pass
    ...
    def get_by_attribute(self, attr_name, attr_value):
        ...
        Args:
            ...
            attr_value: La valeur de l'attribut pour laquelle chercher un
            objet.
...
class InMemoryRepository:
    ...
    def add(self, obj):
        ...
        print(f"Debug: Object with ID {obj.id} added to storage.")
    ...
    def get_all(self, cls=None):
        ...
        Args:
            cls: Classe des objets à récupérer (facultatif). Si ce paramètre
            est fourni, seuls les objets de ce type seront retournés.

        Returns:
            Une liste de tous les objets, ou une liste d'objets d'un certain
            type.
        """
        if cls is None:
    ...
    def delete(self, obj_id):
        ...
        if obj_id in self.storage:
            ...
            print(f"Debug: Object with ID {obj_id} deleted from storage.")
        else:
            print(f"Debug: Object with ID {obj_id} not found for deletion.")
    ...
    def clear_all(self, cls=None):
        ...
        Args:
            cls: Classe des objets à supprimer (facultatif). Si ce paramètre
            est fourni, seuls les objets de ce type seront supprimés.
        """
        if cls is None:
            self.storage.clear()
        else:
    ...
    def get_by_attribute(self, attr_name, attr_value):
        ...
        print(f"Debug: Retrieved object by {attr_name}={attr_value}: {obj}")
        return obj

    def get_all_by_attribute(self, attr_name, attr_value):
        """
        Récupère tous les objets qui ont un certain attribut avec une valeur
        donnée.
        ...
        print(
            f"Debug: Retrieved objects with {attr_name}={attr_value}: "
            f"{objects}"
        )
        return objects
    ...
    def save(self):
        ...
        Dans cette implémentation, la méthode est vide car le stockage est en
        mémoire, donc les changements sont immédiatement reflétés.
        """
        pass
