...
class Place(BaseModel):
    ...
    Cette classe hérite de `BaseModel` et ajoute des fonctionnalités spécifiques aux objets `Place`,
    notamment la gestion du titre, du prix, de la localisation, du propriétaire, ainsi que des
    ...
    def __init__(self, title, price, owner_id, description='',
        ...
        Args:
            ...
            owner (BaseModel ou int/str): Le propriétaire du lieu (soit un ID, soit une instance de BaseModel).
        ...
        """
        super().__init__()  # Appelle le constructeur de la classe parente `BaseModel`
    ...
    def validate_title(self, title):
        ...
        if not title or len(title) > 100:
            raise ValueError(
                "Le titre est requis et doit contenir au maximum 100 caractères.")
        return title
    ...
    def validate_latitude(self, latitude):
        ...
        Raises:
            ValueError: Si la latitude n'est pas dans la plage valide [-90.0, 90.0].
        """
    ...
    def validate_longitude(self, longitude):
        ...
        Raises:
            ValueError: Si la longitude n'est pas dans la plage valide [-180.0, 180.0].
        """
    ...
    def validate_owner(self, owner_id):
        ...
        Args:
            owner (BaseModel, int, str): Le propriétaire à valider (soit un ID, soit une instance de BaseModel).
