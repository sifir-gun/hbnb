...
# Création de l'API Namespace pour les opérations liées aux lieux (places)
...
class PlaceList(Resource):
    ...
    def get(self):
        """
        GET: Récupérer tous les lieux depuis le stockage.
        Retourne une liste de tous les lieux avec le statut HTTP 200.
        """
    ...
    def delete(self):
        """
        DELETE: Supprimer tous les lieux.
...
class PlaceDetail(Resource):
    """
    Ressource pour gérer un lieu spécifique (place) par son ID.
    Permet de récupérer, mettre à jour, ou supprimer un lieu.
    """

    def get(self, place_id):
        """
        GET: Récupérer les détails d'un lieu par son ID.
    ...
    def put(self, place_id):
        """
        PUT: Mettre à jour un lieu spécifique par son ID.
        ...
        # Retourner les détails du lieu mis à jour et le code HTTP 200
        return place.to_dict(), 200

    def delete(self, place_id):
        """
        DELETE: Supprimer un lieu par son ID.
        Retourne un message de confirmation avec le statut HTTP 200 ou une erreur 404 si le lieu n'est pas trouvé.
        """
        # Récupérer le lieu spécifique à partir de son ID
        place = storage.get(place_id)
        if place is None:
