...
class AmenityList(Resource):
    ...
    def post(self):
        ...
        if error:  # If an error occurs, return a 400 status with an error message
...
class AmenityResource(Resource):
    ...
    def get(self, amenity_id):
        ...
        if not amenity:  # If the amenity does not exist, return a 404 status with an error message
    ...
    def delete(self, amenity_id):
        ...
        if not success:  # If the amenity does not exist, return a 404 status with an error message
            return {'error': 'Amenity not found'}, 404
        # Return a success message with a 200 (OK) status
